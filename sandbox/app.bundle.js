...
var require_react_is_development2 = __commonJS((exports2) => {
...
var require_react_is2 = __commonJS((exports2, module2) => {
  "use strict";
  if (false) {
    module2.exports = null;
  } else {
...
function ye(e2) {
  var t2 = import_react.useState(e2.stylisPlugins), n2 = t2[0], s2 = t2[1], c2 = fe(), u2 = import_react.useMemo(function() {
    var t3 = c2;
  ...
  return import_react.useEffect(function() {
    import_shallowequal.default(n2, e2.stylisPlugins) || s2(e2.stylisPlugins);
...
function Ye(e2, t2, n2) {
  ...
  var C, I2 = new se(n2, g2, o2 ? e2.componentStyle : void 0), P2 = I2.isStatic && c2.length === 0, O2 = function(e3, t3) {
    return function(e4, t4, n3, r2) {
      ...
      }(Oe(t4, import_react.useContext(ze), a3) || E, t4, o3), y2 = f2[0], g3 = f2[1], S3 = function(e5, t5, n4, r3) {
        var o4 = fe(), s2 = me(), i4 = t5 ? e5.generateAndInjectStyles(E, o4, s2) : e5.generateAndInjectStyles(n4, o4, s2);
        return import_react.useDebugValue(i4), !t5 && r3 && r3(i4), i4;
      ...
      return t4.style && g3.style !== t4.style && (C2.style = v({}, t4.style, {}, g3.style)), C2.className = Array.prototype.concat(c3, h3, S3 !== h3 ? S3 : null, t4.className, g3.className).filter(Boolean).join(" "), C2.ref = w2, import_react.createElement(_2, C2);
    }(C, e3, t3, P2);
  };
  ...
  }, i2 && import_hoist_non_react_statics.default(C, e2, {attrs: true, componentStyle: true, displayName: true, foldedComponentIds: true, shouldForwardProp: true, styledComponentId: true, target: true, withComponent: true}), C;
}
var qe = function(e2) {
  return function e3(t2, r2, o2) {
    if (o2 === void 0 && (o2 = E), !import_react_is.isValidElementType(r2))
...
function $e(e2) {
  ...
  function l2(e3) {
    var t3 = fe(), n3 = me(), o3 = import_react.useContext(ze), l3 = import_react.useRef(t3.allocateGSInstance(a2)).current;
...
// src/lib/load-nexus.js
var addExternalCss = (src) => {
  const l2 = document.createElement("link");
  l2.setAttribute("rel", "stylesheet");
  l2.setAttribute("href", src);
  document.body.appendChild(l2);
};
var addScript = (src, next) => {
...
var loadNexus = (options) => {
  const {cssUrl: cssUrl2, jsUrl: jsUrl2} = options;
  const promise = new Promise((resolve, reject) => {
    ...
    if (window.Nexus) {
      ...
      addExternalCss(cssUrl2);
      addScript(jsUrl2, onNexusLoaded);
    }
  });
  return promise;
};
var load_nexus_default = loadNexus;
...
// src/app/components/github-corner/index.js
var import_react2 = __toModule(require_react());

// src/app/components/github-corner/github-corner.svg
...
var github_corner_default = SvgComponent;
 ...
 */
var StyledCorner = styled_components_browser_esm_default.a`
...
`;
var Corner = () => /* @__PURE__ */ import_react2.default.createElement(StyledCorner, {
  href: "https://github.com/twinlify/external-platform-demo",
  target: "__blank",
  "aria-label": "View source on GitHub"
}, /* @__PURE__ */ import_react2.default.createElement(github_corner_default, null));
var github_corner_default2 = Corner;

// src/app/components/logo/index.js
var import_react3 = __toModule(require_react());

// src/app/style/breakpoints.js
var size = {
  mobileS: "320px",
  mobileM: "375px",
  mobileL: "425px",
...
var mediaQueryTransition = `transition: all 0.4s`;
...
`;
var Logo = () => /* @__PURE__ */ import_react3.default.createElement($Img, {
  alt: "twinlify",
...
var $$Button = styled_components_browser_esm_default(button_default)`
...
var $Header = styled_components_browser_esm_default.div`
  ...
  align-items: center;
`;
var $DemoSelection = styled_components_browser_esm_default.div`
  display: flex;
  flex-direction: row;
  justify-content: space-between;
`;
var Header = ({selectDemo, selectedDemo}) => {
  const handleClick = (num) => () => selectDemo(num);
  const Buttons = [1, 2, 3].map((num) => /* @__PURE__ */ import_react4.default.createElement($$Button, {
    key: num,
    selected: selectedDemo === num,
    onClick: handleClick(num)
  }, "Demo ", num));
  return /* @__PURE__ */ import_react4.default.createElement($Header, null, /* @__PURE__ */ import_react4.default.createElement(logo_default, null), /* @__PURE__ */ import_react4.default.createElement($DemoSelection, null, Buttons, /* @__PURE__ */ import_react4.default.createElement(github_corner_default2, null)));
};
var header_default = Header;

// src/app/demos/demo1/index.js
var import_axios = __toModule(require_axios2());
var import_react7 = __toModule(require_react());

// src/app/demos/demo1/containers/menu.js
var import_react5 = __toModule(require_react());
var $$Button2 = styled_components_browser_esm_default(button_default)`
  width: 100%;
  height: 40px;
  margin-bottom: 5px;
`;
var $Menu = styled_components_browser_esm_default.div`
  text-align: center;
...
var $List = styled_components_browser_esm_default.div`
  ...
  overflow-y: scroll;
`;
var Menu = ({timeSeries, onSelect}) => {
  const [selectedNum, selectNum] = import_react5.useState(0);
  const handleClick = (num) => () => {
    selectNum(num);
    onSelect(num);
  };
  return /* @__PURE__ */ import_react5.default.createElement($Menu, null, /* @__PURE__ */ import_react5.default.createElement("p", null, "Selection: ", selectedNum), /* @__PURE__ */ import_react5.default.createElement($List, null, timeSeries.map(([date, value], index2) => /* @__PURE__ */ import_react5.default.createElement($$Button2, {
    onClick: handleClick(index2),
    key: index2,
    selected: index2 === selectedNum,
    value,
    date
  }, `data-${index2}`))));
};
...
// src/app/demos/demo1/containers/screen.js
var import_react6 = __toModule(require_react());
var $Screen = styled_components_browser_esm_default.div`
  position: relative;
  text-align: center;
...
`;
var $NexusContainer = styled_components_browser_esm_default.div`
  position: relative;
  background-color: #444444;
  width: calc(100% - 20px);
  height: calc(100%);
`;
var production = window.location.hostname.indexOf("local") === -1;
var containerId = "nexusContainer";
var Screen = (props) => {
  const [nexus, setNexus] = import_react6.useState();
  ...
  return /* @__PURE__ */ import_react6.default.createElement($Screen, null, /* @__PURE__ */ import_react6.default.createElement($Title, null, /* @__PURE__ */ import_react6.default.createElement("p", null, "This demo shows how your platform can integrate the Nexus widget:"), /* @__PURE__ */ import_react6.default.createElement("p", null, "- It performs an HTTP GET request, the way your platform would do, to fetch data,"), /* @__PURE__ */ import_react6.default.createElement("p", null, "- Then it uses the widget's SDK to update the 3D scene each time you select a value on the list.")), /* @__PURE__ */ import_react6.default.createElement($NexusContainer, {
    id: containerId
  }));
};
...
// src/app/demos/demo1/index.js
var $Demo = styled_components_browser_esm_default.div`
  display: flex;
  flex-direction: row;
`;
var fetchDemoTimeSeries = async () => {
  const fetched = await import_axios.default.get("https://connections.twinlify.com/machinechat/demo");
  const result = fetched.data;
  const timeSeries = result.data;
  return timeSeries;
};
var Demo = () => {
  const [timeSeries, setTimeSeries] = import_react7.useState([]);
  const [selectedEntry, selectEntry] = import_react7.useState(null);
  const loadInitialData = async () => {
    const fetchedTimeSeries = await fetchDemoTimeSeries();
    setTimeSeries(fetchedTimeSeries);
    selectEntry(fetchedTimeSeries[0]);
  };
  import_react7.useEffect(loadInitialData, []);
  const handleSelect = (num) => selectEntry(timeSeries[num]);
  return /* @__PURE__ */ import_react7.default.createElement($Demo, null, /* @__PURE__ */ import_react7.default.createElement(menu_default, {
    timeSeries,
    onSelect: handleSelect
  }), /* @__PURE__ */ import_react7.default.createElement(screen_default, {
    selectedEntry
  }));
};
var demo1_default = Demo;

// src/app/demos/demo2/index.js
var import_react8 = __toModule(require_react());
var Demo2 = () => {
  return /* @__PURE__ */ import_react8.default.createElement("div", null, "Demo 2");
};
var demo2_default = Demo2;

// src/app/demos/demo3/index.js
var import_react9 = __toModule(require_react());
var Demo3 = () => {
  return /* @__PURE__ */ import_react9.default.createElement("div", null, "Demo 3");
};
var demo3_default = Demo3;
...
`;
var $App = styled_components_browser_esm_default.div`
  text-align: center;
  ...
  flex-direction: column;
`;
var NEXUS_VERSION = "0.7.2";
var localCss = `http://localhost/nexus-dist/min/nexus-${NEXUS_VERSION}.css`;
var localJs = `http://localhost/nexus-dist/min/nexus-${NEXUS_VERSION}.debug.js`;
var productionCss = `https://static.twinlify.com/apps/nexus-${NEXUS_VERSION}.css`;
var productionJs = `https://static.twinlify.com/apps/nexus-${NEXUS_VERSION}.min.js`;
var production2 = window.location.hostname.indexOf("local") === -1;
var cssUrl = production2 ? productionCss : localCss;
var jsUrl = production2 ? productionJs : localJs;
var Demo4 = (num) => {
  switch (num) {
    case 1:
      return /* @__PURE__ */ import_react10.default.createElement(demo1_default, null);
    case 2:
      return /* @__PURE__ */ import_react10.default.createElement(demo2_default, null);
    case 3:
      return /* @__PURE__ */ import_react10.default.createElement(demo3_default, null);
    default:
      return /* @__PURE__ */ import_react10.default.createElement("p", null, "No demo ", num);
  }
};
var Platform = () => {
  const [loading, setLoading] = import_react10.useState(true);
  const [selectedDemo, selectDemo] = import_react10.useState(1);
  const loadPlatform = async () => {
    await load_nexus_default({
      cssUrl,
      jsUrl
    });
    setLoading(false);
  };
  import_react10.useEffect(loadPlatform, []);
  return /* @__PURE__ */ import_react10.default.createElement($App, null, /* @__PURE__ */ import_react10.default.createElement(GlobalStyle, null), /* @__PURE__ */ import_react10.default.createElement(header_default, {
    selectDemo,
    selectedDemo
  }), loading ? /* @__PURE__ */ import_react10.default.createElement("p", null, "Loading...") : Demo4(selectedDemo));
};
var platform_default = Platform;

// src/index.js
var createPlatform = (options = {}) => {
  if (!options.containerId) {
    console.error("[createPlatform] Requires a containerId.");
  }
  const container = document.getElementById(options.containerId);
  import_react_dom.render(/* @__PURE__ */ import_react11.default.createElement(platform_default, null), container);
};
